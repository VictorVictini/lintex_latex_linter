...
\\\includegraphics[alt={tongue_twister}]{tongue_twister.jpg}\\ % use actual text
...
\\\includegraphics[alt={simple_house}]{simple_house.png}\\ % use alt text

I have many pets, but my favourite is my cat. Cats are great!
\\\includegraphics[alt={cat}]{cat.png}\\ % use decorative (artifact) or alt text
