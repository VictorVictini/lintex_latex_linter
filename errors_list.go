...
var (
	...
	GRAPHICS_SEVERAL_CLASS_ARGUMENTS      = CustomErrorWrapper("\\includegraphics should only have one required argument.", "long desc", newAccessibilityError)
	GRAPHICS_SEVERAL_OPTIONAL_ARGUMENTS   = CustomErrorWrapper("\\includegraphics should only have one optional argument.", "long desc", newAccessibilityError)
