...
var (
	...
	METADATA_SEVERAL_CLASS_ARGUMENTS        = CustomErrorWrapper("\\DocumentMetadata should only have one required argument. For example, '\\DocumentMetadata{tagging=on}'.", "long desc", newAccessibilityError)
